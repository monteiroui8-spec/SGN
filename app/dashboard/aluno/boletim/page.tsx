                        ...
                        {notas.map((nota, index) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="text-center py-4 px-2 font-medium">{nota.prova_professor ?? "—"}</td>
                              <td className="text-center py-4 px-2 font-medium">{nota.avaliacao ?? "—"}</td>
                              <td className="text-center py-4 px-2 font-medium">{nota.prova_trimestre ?? "—"}</td>
                              <td className="text-center py-4 px-2 font-medium">{nota.prova_trimestre ?? "—"}</td>
